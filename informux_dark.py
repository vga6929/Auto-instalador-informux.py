...
opcion3 = pyfiglet.figlet_format("3")
...
if usuario == '1':
           ...
           print(metasploit)
           os.system('mkdir -p $PREFIX/etc/apt/sources.list.d && apt install wget -y&& wget https://raw.githubusercontent.com/ivam3/termux-packages/gh-pages/ivam3-termux-packages.list -O  $PREFIX/etc/apt/sources.list.d/ivam3-termux-packages.list && apt update && apt upgrade -y && apt install metasploit-framework -y')
elif usuario == '2':
             os.system('cls' if os.name == 'nt' else 'clear')             
...
apt update && apt install i-haklab')
             ...
             os.system('cls' if os.name == 'nt' else 'clear')
             burpsuite = pyfiglet.figlet_format("INSTALANDO ")
             print(burpsuite)
             os.system('dir')
elif usuario == '4':
             sys.exit()
